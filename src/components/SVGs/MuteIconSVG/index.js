...
function MuteIconSVG(props) {
  ...
  return (
    ...
    <style>
    {`
    .MuteIconSVGbackground {
        fill: ${Colors.regularRed};
        stroke:${Colors.regularRed};
        stroke-miterlimit:10;
        stroke-width:'2px'
    }
    .MuteIconSVGforeground {
        fill: ${Colors.offWhite};
    }
    .MuteIconSVG:hover > svg > .MuteIconSVGbackground {
        fill: #CB3750;
    }
    `}
    </style>
    <div
    className="MuteIconSVG"
    style={Object.assign({
