    ...
    <Fragment>
      ...
      >
        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 362 362">
          {props.noBackground ? null : (
            <circle
              className="HangUpIconSVGbackground"
              cx="181"
              cy="181"
              r="180"
            />
