            ...
            <svg viewBox="0 0 40 40">
                <g id="One-Time_Extended_Hours">
                    ...
                    />
                        ...
                        <g id="_1">
                            <StyledSVGText 
                                transform="matrix(1 0 0 1 13.4 28)"
                            >
                                1
                            </StyledSVGText>
                        </g>
...
OneTimeExtendedHoursSVG.propTypes = {
    size: PropTypes.number
}

OneTimeExtendedHoursSVG.defaultProps = {
    size: 25
}

export default OneTimeExtendedHoursSVG;
