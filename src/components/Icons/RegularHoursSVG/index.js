            ...
            <svg viewBox="0 0 40 40">
                <g id="Regular_Hours">
                    ...
                    <g id="Regular_Hours_Symbol">
                        ...
                        <g id="Repeat_Cycle_-_White">
                            <g id="Repeat_Cycle_-_White-2">
                                <g id="Group_46">
                                    <StyledPath2 
                                        id="Path_71" 
                                        d="M16.2,27.3L16.2,27.3c1.4,0.9,3,1.2,4.6,1.1c2.5-0.3,4.7-1.9,5.7-4.2
                                        c0.4-0.8,0.6-1.7,0.6-2.6h1.7c0.3,0,0.6-0.3,0.6-0.6c0,0,0,0,0,0c0-0.1-0.1-0.3-0.2-0.4l-2.9-2.9c-0.2-0.2-0.6-0.2-0.8,0
                                        l-2.9,2.9c-0.2,0.2-0.2,0.6,0,0.8c0.1,0.1,0.2,0.2,0.4,0.2h1.8c0,0.6-0.2,1.2-0.4,1.7c-0.9,2.1-3.2,3.3-5.4,2.8
                                        c-0.4-0.1-0.7-0.3-1.1-0.4c-0.1-0.1-0.2-0.1-0.3,0l-1.2,1.2C16.1,27,16.1,27.1,16.2,27.3C16.2,27.3,16.2,27.3,16.2,27.3
                                        L16.2,27.3z M10.8,22.2l2.9,2.9c0.2,0.2,0.6,0.2,0.8,0l2.9-2.9c0.2-0.2,0.2-0.6,0-0.8c-0.1-0.1-0.3-0.2-0.4-0.2h-1.8
                                        c0-1.2,0.5-2.3,1.4-3.2c1.2-1.2,2.8-1.6,4.4-1.2c0.4,0.1,0.7,0.3,1.1,0.4c0.1,0.1,0.2,0.1,0.4,0l1.3-1.3
                                        c0.1-0.1,0.1-0.3,0-0.4c0,0,0,0,0,0l0,0c-1.4-0.9-3-1.2-4.6-1.1c-1.6,0.1-3.1,0.9-4.2,2c-1.3,1.3-2,3-2.1,4.8h-1.7
                                        c-0.3,0-0.6,0.3-0.6,0.6c0,0,0,0,0,0C10.7,22,10.7,22.2,10.8,22.2L10.8,22.2z"
                                    />
                                </g>
                            </g>
                        </g>
...
RegularHoursSVG.propTypes = {
    size: PropTypes.number
}

RegularHoursSVG.defaultProps = {
    size: 25
}

export default RegularHoursSVG;
