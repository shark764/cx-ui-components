...
function BlackoutRecurringExceptionSVG({ size }) {
    return (
            ...
            <svg viewBox="0 0 40 40">
                <g id="Blackout_Recurring_Exception">
                    ...
                    <g id="X">
                        <StyledPath2 
                            id="X-2" 
                            d="M21.4,21.4l4.4-4.4c0.4-0.3,0.4-0.9,0.1-1.3c-0.3-0.4-0.9-0.4-1.3-0.1c0,0-0.1,0.1-0.1,0.1L20,20.1
                            l-4.4-4.4c-0.4-0.3-1-0.2-1.3,0.2c-0.2,0.3-0.2,0.8,0,1.1l4.4,4.4l-4.4,4.4c-0.3,0.4-0.3,1,0,1.3c0.2,0.2,0.4,0.3,0.7,0.3
                            c0.3,0,0.5-0.1,0.7-0.3l4.4-4.4l4.4,4.4c0.2,0.2,0.4,0.3,0.7,0.3c0.3,0,0.5-0.1,0.7-0.3c0.3-0.4,0.3-1,0-1.3L21.4,21.4z"
                        />
                    </g>
                </g>
            </svg>
...
BlackoutRecurringExceptionSVG.propTypes = {
    size: PropTypes.number
}

BlackoutRecurringExceptionSVG.defaultProps = {
    size: 25
}

export default BlackoutRecurringExceptionSVG;
